...
|                              | Java         | Weidong   | :running_man:            | 1/15    | [Code](https://github.com/allenjzhang/typespec-e2e-demo/tree/main/todoApp/clients/java) | Pagination depends on clientcore beta.2. ETA 1/20. |
