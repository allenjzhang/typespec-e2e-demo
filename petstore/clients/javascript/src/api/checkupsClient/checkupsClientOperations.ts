...
import { CheckupsClientContext } from "./checkupsClientContext.js";
...
export interface ListOptions extends OperationOptions {
  ...
  const path = parse("/checkups").expand({
