import { TodoPage, TodoLabels, TodoAttachment, TodoItem, ToDoItemMultipartRequest, TodoItemPatch } from "../../models/models.js";
import { parse } from "uri-template";
import { jsonTodoPageToApplicationTransform, jsonTodoItemToTransportTransform, jsonArrayTodoAttachmentToTransportTransform, dateDeserializer, jsonTodoLabelsToApplicationTransform, jsonTodoLabelsToTransportTransform, jsonTodoItemPatchToTransportTransform } from "../../models/internal/serializers.js";
...
export interface ListOptions extends OperationOptions {
  ...
  options?: ListOptions,): Promise<TodoPage> {
...
export interface CreateJsonOptions extends OperationOptions {
  ...
  client: TodoItemsClientContext,
  item: TodoItem,
  options?: CreateJsonOptions,): Promise<{"id": number;
"title": string;
"createdBy": number;
"assignedTo"?: number;
"description"?: string;
...
"labels"?: TodoLabels;}> {
  ...
  const httpRequestOptions = {
    headers: {
      ...
      "item": jsonTodoItemToTransportTransform(item),"attachments": jsonArrayTodoAttachmentToTransportTransform(options?.attachments)
    },
  };
...
export interface CreateFormOptions extends OperationOptions {
  ...
  options?: CreateFormOptions,): Promise<{"id": number;
"title": string;
"createdBy": number;
"assignedTo"?: number;
"description"?: string;
...
"labels"?: TodoLabels;}> {
  ...
  const httpRequestOptions = {
    headers: {
      ...
      name: "item",
      body: {
        "title": body.item.title,"assignedTo": body.item.assignedTo,"description": body.item.description,"status": body.item.status,"labels": jsonTodoLabelsToTransportTransform(body.item.labels),"_dummy": body.item._dummy
      }
    },
    ...(body.attachments ?? []).map((attachments: any) => (createFilePartDescriptor(
      "attachments",
      attachments
    )) )],
  };
...
export interface GetOptions extends OperationOptions {
  ...
  client: TodoItemsClientContext,
  id: number,
  options?: GetOptions,): Promise<{"id": number;
"title": string;
"createdBy": number;
"assignedTo"?: number;
"description"?: string;
...
export interface UpdateOptions extends OperationOptions {
  ...
  id: number,
  patch: TodoItemPatch,
  options?: UpdateOptions,): Promise<{"id": number;
"title": string;
"createdBy": number;
"assignedTo"?: number;
"description"?: string;
