import { TodoItemPatch, TodoAttachment, User, Page, FileAttachmentMultipartRequest, File, TodoPage, TodoItem, TodoLabels, TodoLabelRecord, ToDoItemMultipartRequest } from "../models.js";
...
export function decodeBase64(value: string): Uint8Array | undefined {
...
}export function createJsonAttachmentPayloadToTransport(
  payload: TodoAttachment,) {
  ...
  if(!input_) {
    ...
    return {
    "id": input_.id,"username": input_.username,"email": input_.email,"password": input_.password,"validated": input_.validated
  }!;
...
}export function jsonArrayTodoAttachmentToTransportTransform(
  items_?: Array<TodoAttachment> | null,): any {
  if(!items_) {
...
}export function jsonArrayTodoAttachmentToApplicationTransform(
  items_?: any,): Array<TodoAttachment> {
  if(!items_) {
    return items_ as any;
  }
  const _transformedArray = [];
  ...
  return _transformedArray as any;
}export function jsonTodoAttachmentToTransportTransform(
  input_?: TodoAttachment | null,): any {
  if(!input_) {
    return input_ as any;
  }
    return {
    "filename": input_.filename,"mediaType": input_.mediaType,"contents": encodeUint8Array(input_.contents, "base64")!
  }!;
}export function jsonTodoAttachmentToApplicationTransform(
  input_?: any,): TodoAttachment {
  if(!input_) {
    return input_ as any;
  }
    return {
    "filename": input_.filename,"mediaType": input_.mediaType,"contents": decodeBase64(input_.contents)!
  }!;
}export function jsonFileAttachmentMultipartRequestToTransportTransform(
  input_?: FileAttachmentMultipartRequest | null,): any {
  if(!input_) {
    return input_ as any;
  }
    return {
  ...
  if(!input_) {
    ...
    return {
    "contentType": input_.contentType,"filename": input_.filename,"contents": encodeUint8Array(input_.contents, "base64")!
  }!;
  ...
  if(!input_) {
    ...
    return {
    "contentType": input_.contentType,"filename": input_.filename,"contents": decodeBase64(input_.contents)!
  }!;
}export function jsonTodoPageToTransportTransform(
  input_?: TodoPage | null,): any {
  if(!input_) {
    return input_ as any;
  }
    return {
    "items": jsonArrayTodoItemToTransportTransform(input_.items),"pageSize": input_.pageSize,"totalSize": input_.totalSize,"limit": input_.limit,"offset": input_.offset,"prevLink": input_.prevLink,"nextLink": input_.nextLink
  }!;
  ...
  if(!input_) {
    ...
    return {
    "items": jsonArrayTodoItemToApplicationTransform(input_.items),"pageSize": input_.pageSize,"totalSize": input_.totalSize,"limit": input_.limit,"offset": input_.offset,"prevLink": input_.prevLink,"nextLink": input_.nextLink
  }!;
}export function jsonArrayTodoItemToTransportTransform(
  items_?: Array<TodoItem> | null,): any {
  if(!items_) {
    return items_ as any;
  }
  const _transformedArray = [];
  ...
  return _transformedArray as any;
}export function jsonArrayTodoItemToApplicationTransform(
  items_?: any,): Array<TodoItem> {
  if(!items_) {
    return items_ as any;
  }
  const _transformedArray = [];
...
}export function jsonTodoLabelsToTransportTransform(
  input_?: TodoLabels | null,): any {
  if(!input_) {
    return input_ as any;
  }return input_
}export function jsonTodoLabelsToApplicationTransform(
  input_?: any,): TodoLabels {
  if(!input_) {
    return input_ as any;
  }return input_
}export function jsonArrayStringToTransportTransform(
  items_?: Array<string> | null,): any {
  if(!items_) {
    return items_ as any;
  }
  const _transformedArray = [];
  ...
  return _transformedArray as any;
}export function jsonTodoLabelRecordToTransportTransform(
  input_?: TodoLabelRecord | null,): any {
  if(!input_) {
    return input_ as any;
  }
    return {
    "name": input_.name,"color": input_.color
  }!;
}export function jsonTodoLabelRecordToApplicationTransform(
  input_?: any,): TodoLabelRecord {
  if(!input_) {
    return input_ as any;
  }
    return {
...
}export function jsonArrayTodoLabelRecordToTransportTransform(
  items_?: Array<TodoLabelRecord> | null,): any {
  if(!items_) {
    return items_ as any;
  }
  const _transformedArray = [];
  ...
  items_?: any,): Array<TodoLabelRecord> {
  if(!items_) {
    return items_ as any;
  }
  const _transformedArray = [];
  ...
  input_?: ToDoItemMultipartRequest | null,): any {
  if(!input_) {
    return input_ as any;
  }
    return {
    "item": jsonTodoItemToTransportTransform(input_.item),"attachments": jsonArrayHttpPartToTransportTransform(input_.attachments)
  }!;
}export function jsonToDoItemMultipartRequestToApplicationTransform(
  input_?: any,): ToDoItemMultipartRequest {
  if(!input_) {
    return input_ as any;
  }
    return {
    "item": jsonTodoItemToApplicationTransform(input_.item),"attachments": jsonArrayHttpPartToApplicationTransform(input_.attachments)
  }!;
}export function jsonArrayHttpPartToTransportTransform(
  items_?: Array<File> | null,): any {
  if(!items_) {
    return items_ as any;
  }
  const _transformedArray = [];
  ...
  return _transformedArray as any;
}export function jsonArrayHttpPartToApplicationTransform(
  items_?: any,): Array<File> {
  if(!items_) {
    return items_ as any;
  }
  const _transformedArray = [];
  ...
  input_?: TodoItemPatch | null,): any {
  if(!input_) {
    return input_ as any;
  }
    return {
    "title": input_.title,"assignedTo": input_.assignedTo,"description": input_.description,"status": input_.status
  }!;
}export function jsonTodoItemPatchToApplicationTransform(
  input_?: any,): TodoItemPatch {
  if(!input_) {
    return input_ as any;
  }
    return {
