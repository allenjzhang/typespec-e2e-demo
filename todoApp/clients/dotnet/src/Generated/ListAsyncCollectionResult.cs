...
namespace Todo
{
    internal partial class ListAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        public ListAsyncCollectionResult(TodoItems client, Uri nextPage, int? limit, int? offset, RequestOptions options)
        {
            _client = client;
            _nextPage = nextPage;
            _limit = limit;
