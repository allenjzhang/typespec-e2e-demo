...
namespace Todo._Users
{
    ...
    public partial class Users
    {
        ...
        internal Users(ClientPipeline pipeline, Uri endpoint)
        {
            _endpoint = endpoint;
            Pipeline = pipeline;
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual ClientResult<UserCreatedResponse> Create(User user, CancellationToken cancellationToken = default)
        {
            ...
            return ClientResult.FromValue((UserCreatedResponse)result, result.GetRawResponse());
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="user"/> is null. </exception>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        public virtual async Task<ClientResult<UserCreatedResponse>> CreateAsync(User user, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(user, nameof(user));
