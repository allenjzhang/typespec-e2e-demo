...
namespace Todo
{
    internal partial class ListCollectionResultOfT : CollectionResult<TodoItem>
    {
        ...
        public ListCollectionResultOfT(TodoItems client, Uri nextPage, int? limit, int? offset, RequestOptions options)
        {
            _client = client;
            _nextPage = nextPage;
            _limit = limit;
        ...
        protected override IEnumerable<TodoItem> GetValuesFromPage(ClientResult page)
        {
            return ((TodoPage)page).Items;
        }
    }
}
