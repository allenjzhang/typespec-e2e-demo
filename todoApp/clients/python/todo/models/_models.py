...
class FileAttachmentMultipartRequest(_Model):
    """FileAttachmentMultipartRequest.

    :ivar contents: Required.
    :vartype contents: ~todo._utils.utils.FileType
    """
...
class ToDoItemMultipartRequest(_Model):
    """ToDoItemMultipartRequest.

    :ivar item: Required.
    :vartype item: ~todo.models.TodoItem
    :ivar attachments:
    :vartype attachments: list[~todo._utils.utils.FileType]
    """
